...
class nercLSTM(nn.Module):
    def __init__(self, codes):
        ...
        total_dim = emb_words + emb_sufs + emb_lw + emb_features + emb_prefs+emb_bigrams+emb_trigrams
        ...
        #trigrams
        self.embTG = nn.Embedding(n_trigrams, emb_trigrams)  # Embeddings for lowercased words
    ...
    def forward(self, words, suffixes, lcwords, features,prefixes,bigrams,trigrams):
        ...
        emb_trigrams = self.embTG(trigrams)
        ...
        x = torch.cat((emb_words, emb_sufs, emb_lcwords, features,emb_prefs,emb_bigrams,emb_trigrams), dim=2)
